...
| [maf-procurement-harness](dotnet/maf-procurement-harness/)                     | Procurement quote review using Agent Harness with todo tracking, controlled file access, file-backed memory, and approval-aware output writes.                                               |
